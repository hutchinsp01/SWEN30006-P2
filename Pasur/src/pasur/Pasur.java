...
public class Pasur implements IObservable
{
    ...
    public void play()
    {
        ...
        {
            roundOfGame++;
            notifyObserver("Round " + roundOfGame + " of the game starts...");
            ...
            while (!deckHand.isEmpty())
            {
                ...
                for(int i = 0; i < N_HAND_CARDS; i++)
                {
                    ...
                    for(int j = 0, k = currentStartingPlayerPos; j < nPlayers; j++)
                    {
                        ...
                        if(!cardsToPick.isEmpty())
                        {
                            ...
                            notifyObserver(player.toString() + " picks " + toString(cardList));
                            ...
                            if(isAsur(playedCard, isLastRound))
                            {
                            	...
                            	notifyObserver(player.toString() + " scores a sur");
                        ...
                        {
                        	notifyObserver(player.toString() + " picks " + toString(cardsToPick));
                ...
                if(isLastRound)
                {
                    ...
                    if(!poolCards.isEmpty())
                    	...
                    	notifyObserver(lastPlayerWhoPickedAcard + " picks " + toString(poolCards) + " at the end of this round of game");
            ...
            notifyObserver("Round " + roundOfGame + " of the game ends...");
        ...
        notifyObserver(winningText);
        //System.out.println(winningText);
        
        notifyObserver("ENDLOG");
...
//        scoreLabel.setText(scoreString);
    ...
    private void dealingOutToPlayers(int currentStartingPlayerPos)
    {
        ...
        for (int i = 0, k = currentStartingPlayerPos; i < nPlayers; i++)
        {
            ...
            notifyObserver(player.toString() + " hand: " + toString(player.getHand().getCardList()));
    ...
    {
    	notifyObserver("Dealing out to pool...");
        ...
        notifyObserver("Pool: " + toString(poolHand.getCardList()));
